...
Public Class gameMainInterface
    ...
    Private Sub load_interface()
        ...
        If Not String.IsNullOrEmpty(imagePath) Then
            ...
            End If
        End If
        If Not String.IsNullOrEmpty(missileImg) AndAlso System.IO.File.Exists(missileImg) Then
            Image1.Image = Image.FromFile(missileImg)
            Image1.BackColor = Color.Transparent
            missile1.Image = Image.FromFile(missileImg)
            missile2.Image = Image.FromFile(missileImg)
            missile3.Image = Image.FromFile(missileImg)
            missile4.Image = Image.FromFile(missileImg)
            missile5.Image = Image.FromFile(missileImg)
        End If
        If Not String.IsNullOrEmpty(planetAImg) AndAlso System.IO.File.Exists(planetAImg) Then
            Image4.Image = Image.FromFile(planetAImg)
            Image4.SizeMode = PictureBoxSizeMode.Zoom
            Image4.BackColor = Color.Transparent

        End If
        If Not String.IsNullOrEmpty(planetBImg) AndAlso System.IO.File.Exists(planetBImg) Then
            Image2.Image = Image.FromFile(planetBImg)
            Image2.SizeMode = PictureBoxSizeMode.Zoom
            Image2.BackColor = Color.Transparent

        End If
        If Not String.IsNullOrEmpty(spaceshipImg) AndAlso System.IO.File.Exists(spaceshipImg) Then
            Image3.Image = Image.FromFile(spaceshipImg)
